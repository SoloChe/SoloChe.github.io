...
\begin{itemize}
	\item \noindent {\bf Postdoctoral Scholar at Arizona State University} (Advised by Dr. Teresa Wu)
        ...
        \begin{itemize}[label=$\bullet$]
			...
			\item \noindent {\bf Biomedical Age Prediction with Epigenetic Data for Alzheimer's Disease Detection}
			\begin{itemize}[label=$-$]
...
\begin{enumerate}
	...
	\item ``Harmonizing florbetapir and PiB PET measurements using modified Cycle-GAN model''
