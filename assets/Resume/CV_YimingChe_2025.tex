...
\vspace{-0.5em}
 \begin{itemize}
	...
	% \vspace{-0.4em}
 	...
 	\vspace{-0.4em}
 	\item {\bf ML Frameworks:} PyTorch, TensorFlow, scikit-learn, HuggingFace, LangChain/LangGraph
 	\vspace{-0.4em}
	...
	\item \noindent {\bf Senior ML/Data Scientist at Walmart Global Tech}\\
		...
		\begin{itemize}[label=$\bullet$]
			...
			\begin{itemize}[label=$\bullet$]
				...
				\item Deployed the RAG system on \textbf{GCP} using \textbf{Airflow}.
				\item Explored and analyzed large-scale campaign and purchase data using \textbf{PySpark}.
			\end{itemize}

			\item \noindent {\bf Led Development of Campaign Notification Click Model (In Progress)}
			\vspace{-0.5em}
			\begin{itemize}[label=$\bullet$]
				\item Developed \textbf{PySpark} pipeline for data preprocessing and feature engineering for campaign notification click model.
			\end{itemize}

			\item \noindent {\bf Led Development of Recommendation of Walmart Store Items (In Progress)}
			\vspace{-0.5em}
			\begin{itemize}[label=$\bullet$]
				\item Developed \textbf{PySpark} pipeline for best store selling item monitor.
			\end{itemize}
		\end{itemize}
