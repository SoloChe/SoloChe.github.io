...
\begin{itemize}
	...
	\item \noindent {\bf Senior ML/Data Scientist at Walmart Global Tech}\\
		...
		\begin{itemize}[label=$\bullet$]
			...
			\begin{itemize}[label=$\bullet$]
				\setlength\itemsep{0.5pt}
				\item Developed campaign-2-PT RAG system using \textbf{PyTorch} and \textbf{HuggingFace} to retrieve campaign-related products for campaign ranker label generation.
				\item Preprocessed large-scale product and campaign datasets using \textbf{PySpark}.
			\end{itemize}

			\item \noindent {\bf Co-led Development of Campaign Push/Notification (In Progress)}
			\vspace{-0.5em}
			\begin{itemize}[label=$\bullet$]
				\item Developed \textbf{PySpark} pipeline to monitor campaign quality.
			\end{itemize}
		\end{itemize}
