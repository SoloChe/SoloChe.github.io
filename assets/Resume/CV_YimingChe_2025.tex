...
\vspace{-0.5em}
 \begin{itemize}
	...
	% \vspace{-0.4em}
 	...
 	\vspace{-0.4em}
 	\item {\bf Cloud/DevOps:} AWS(S3, EC2), SageMaker, Docker, CI/CD, MLflow/Wandb, Flask
 	\vspace{-0.4em}
	\item {\bf Tools:} Linux (Slurm), Git/GitHub, Bash
 	\vspace{-0.4em}
 \end{itemize}
...
\begin{itemize}
	...
	\item \noindent {\bf Postdoctoral Scholar at Arizona State University \\ Research (Data) Scientist at ASU-Mayo Center for Innovative Imaging (Concurrent)}\\
        ...
        \begin{itemize}[label=$\bullet$]
			...
			\item \noindent \textbf{Led Development of End-to-End Multi-agent Medical Q\&A System (In Progress)}
			\vspace{-0.5em}
			\begin{itemize}[label=$\bullet$]
			\setlength\itemsep{0.5pt}
			...
			\begin{itemize}[label=$\bullet$]
				...
				\item Applied \textbf{SHAP analysis} and \textbf{A/B test} (Wald test) for feature importance in cognitive decline prediction. \textbf{Identified top 5 features}, providing insights to the clinical research. (\href{https://journals.sagepub.com/doi/abs/10.1177/13872877241306654}{paper})
...
\vspace{-0.5em}
\hspace{1.2em}\textbf{Summary:} 14 publications, including 8 first-author papers (13 journal articles, 1 conference paper, 3 working papers).
\vspace{-0.5em}
\begin{enumerate}
	\setlength\itemsep{0.5pt}
