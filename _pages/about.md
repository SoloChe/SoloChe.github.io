...
<p style="text-align: justify;"> <strong>Research: </strong> I'm currently interested in generative model, e.g., medical imaging with diffusion models and vision autoregressive models, Bayesian deep learning, Gaussian process. I'm switching my research direction to bioinformatics with deep learning.
